...
export const likePhoto = createAction(
  '[Photos] Like Photo', props<{ id: PHOTO_TO_VIEW['id'] }>()
);
export const unlikePhoto = createAction(
  '[Photos] UnLike Photo', props<{ id: PHOTO_TO_VIEW['id'] }>()
);
...
export const loadPaginatedPhotos = createAction('[Photos] paginated photos', props<{page:number,perPage?:number}>())
export const loadPaginatedPhotosSuccess = createAction('[Photos] paginated photos Success', props<{photos:PHOTO_TO_VIEW[]}>())
export const photoLikeOrUnlikeSuccess=createAction('[Photos] Like Or Unlike Success',props<{photo:PHOTO_TO_VIEW}>())
